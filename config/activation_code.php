...
return [
    'default' => [
        ...
        'code_generate_mode' => env(
            ...
            ActivationCodeService::GENERATE_CODE_MODE_ALL
        ),
    ...
    'sms' => [
        ...
        'code_generate_mode' => env(
            ...
            ActivationCodeService::GENERATE_CODE_MODE_NUMBER
        ),
    ...
    */
    ...
    | Model
    |--------------------------------------------------------------------------
    | Default: \Crow\LaravelActivationCode\Model\ActivationCode::class
    | Change to your custom class if you need to extend the model or change the table name
    | A custom class must inherit the base class \Crow\LaravelActivationCode\Model\ActivationCode
    */

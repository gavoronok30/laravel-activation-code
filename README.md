...
```
$app->register(\Gavoronok30\LaravelActivationCode\Providers\ActivationCodeServiceProvider::class);
```
Uncommented strings
```
$app->withFacades();
...
Add to section
```
        \Gavoronok30\LaravelActivationCode\Providers\ActivationCodeServiceProvider::class,
```
Example
```
    'providers' => [
...
For creating config file
```
php artisan vendor:publish --provider="Gavoronok30\LaravelActivationCode\Providers\ActivationCodeServiceProvider" --tag=config
```
For creating migration file
```
php artisan activation:code:publish --tag=migration
...
```
$service = app(\Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::class);
```
...
Returned **\Gavoronok30\LaravelActivationCode\Model\ActivationCode** eloquent model
...
```
$service
    ->setMode(\Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::MODE_SMS)
    ->setGenerateCodeMode(\Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_ALPHABET_LOWER)
    ->setCodeLength(7)
    ->setCodeTTL('20m')
    ->setMaxAttempt(3);
$service
...
- - **Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_ALPHABET** (1) - only letters, case insensitive
- - **Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_ALPHABET_LOWER** (2) - only lowercase letters
- - **Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_ALPHABET_UPPER** (3) - only uppercase letters
- - **Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_NUMBER** (4) - only numbers
- - **Gavoronok30\LaravelActivationCode\ActivationCodeServiceInterface::GENERATE_CODE_MODE_ALL** (5) - (default) letters and numbers
